...
export const Group = ({ property1, className, text = "Legazpi" }: Props): JSX.Element => {
  ...
  return (
    <div className={`w-[1240px] h-[350px] relative ${className}`}>
      <div
        className={`absolute ${state.property1 === "variant-2" ? "w-[314px]" : "w-[299px]"} ${state.property1 === "variant-2" ? "left-[-7px]" : "left-0"
      ...
      >
        ...
        >
          <div
            className={`font-heading-7 tracking-[var(--heading-7-letter-spacing)] [font-style:var(--heading-7-font-style)] text-[length:var(--heading-7-font-size)] opacity-75 text-gray absolute font-[number:var(--heading-7-font-weight)] whitespace-nowrap leading-[var(--heading-7-line-height)] ${state.property1 === "variant-2" ? "w-[115px]" : ""
          ...
          <div
            className={`font-heading-4 tracking-[var(--heading-4-letter-spacing)] [font-style:var(--heading-4-font-style)] text-[length:var(--heading-4-font-size)] text-black absolute font-[number:var(--heading-4-font-weight)] leading-[var(--heading-4-line-height)] ${state.property1 === "variant-2" ? "w-[142px]" : ""
          ...
          <div
            className={`bg-cover bg-[50%_50%] absolute ${state.property1 === "variant-2" ? "w-[133px]" : "w-[127px]"} ${state.property1 === "variant-2" ? "left-[17px]" : "left-4"
              } ${state.property1 === "variant-2" ? "top-[17px]" : "top-4"} ${state.property1 === "default" ? "h-[242px]" : state.property1 === "variant-2" ? "h-[247px]" : "h-[235px]"
          ...
          />
          <div
            className={`bg-cover bg-[50%_50%] absolute ${state.property1 === "variant-2" ? "w-[135px]" : "w-32"} ${state.property1 === "variant-2" ? "left-[159px]" : "left-[151px]"
              } ${state.property1 === "variant-2" ? "top-[17px]" : "top-4"} ${state.property1 === "default"
          ...
          <div
            className={`bg-cover bg-[50%_50%] absolute ${state.property1 === "variant-2" ? "w-[135px]" : "w-32"} ${state.property1 === "variant-2" ? "left-[159px]" : "left-[151px]"
              } ${state.property1 === "variant-2" ? "top-[145px]" : "top-[138px]"} ${state.property1 === "default"
      ...
      <div
        className={`absolute ${state.property1 === "variant-3" ? "w-[314px]" : "w-[299px]"} ${state.property1 === "variant-3" ? "left-[310px]" : "left-[315px]"
      ...
      >
        ...
        >
          <div
            className={`font-heading-7 [font-style:var(--heading-7-font-style)] tracking-[var(--heading-7-letter-spacing)] text-[length:var(--heading-7-font-size)] opacity-75 text-gray absolute font-[number:var(--heading-7-font-weight)] whitespace-nowrap leading-[var(--heading-7-line-height)] ${state.property1 === "variant-3" ? "w-[111px]" : ""
          ...
          <div
            className={`bg-cover bg-[50%_50%] absolute ${state.property1 === "variant-3" ? "w-[138px]" : "w-[131px]"} ${state.property1 === "variant-3" ? "left-[17px]" : "left-4"
              } ${state.property1 === "variant-3" ? "top-[17px]" : "top-4"} ${state.property1 === "variant-3" ? "h-[247px]" : "h-[235px]"
              } ${state.property1 === "default"
          ...
          <div
            className={`bg-cover bg-[50%_50%] absolute ${state.property1 === "variant-3" ? "w-[133px]" : "w-[127px]"} ${state.property1 === "variant-3" ? "left-40" : "left-[152px]"
              } ${state.property1 === "variant-3" ? "top-[17px]" : "top-4"} ${state.property1 === "default"
          ...
          />
          <div
            className={`font-heading-4 [font-style:var(--heading-4-font-style)] tracking-[var(--heading-4-letter-spacing)] text-[length:var(--heading-4-font-size)] text-black absolute font-[number:var(--heading-4-font-weight)] leading-[var(--heading-4-line-height)] ${state.property1 === "variant-3" ? "w-[203px]" : ""
          ...
          <div
            className={`absolute ${state.property1 === "variant-3" ? "w-[133px]" : "w-[127px]"} ${state.property1 === "variant-3" ? "left-40" : "left-[152px]"
              } ${state.property1 === "variant-3" ? "top-[145px]" : "top-[138px]"} ${state.property1 === "default" ? "bg-cover" : "bg-[100%_100%]"
              } ${state.property1 === "default"
                ? "bg-[url(/static/img/nice-place-to-spend-some-1.png)]"
                : state.property1 === "variant-3"
                  ? "bg-[url(/static/img/images-6-1.png)]"
                  : "bg-[url(/static/img/images-6-3.png)]"
              } ${state.property1 === "variant-3" ? "h-[119px]" : "h-[113px]"} ${state.property1 === "default" ? "bg-[50%_50%]" : ""
              }`}
          />
        </div>
      </div>
      ...
      >
        ...
        >
          <div
            className={`font-heading-7 [font-style:var(--heading-7-font-style)] tracking-[var(--heading-7-letter-spacing)] text-[length:var(--heading-7-font-size)] opacity-75 text-gray absolute font-[number:var(--heading-7-font-weight)] whitespace-nowrap leading-[var(--heading-7-line-height)] ${state.property1 === "variant-4" ? "w-[106px]" : ""
          ...
          <div
            className={`bg-cover bg-[50%_50%] absolute ${state.property1 === "variant-4" ? "w-[133px]" : "w-[127px]"} ${state.property1 === "variant-4" ? "left-[17px]" : "left-4"
              } ${state.property1 === "variant-4" ? "top-[17px]" : "top-4"} ${state.property1 === "variant-4" ? "h-[247px]" : "h-[235px]"
          ...
          />
          <div
            className={`font-heading-4 [font-style:var(--heading-4-font-style)] tracking-[var(--heading-4-letter-spacing)] text-[length:var(--heading-4-font-size)] text-black absolute font-[number:var(--heading-4-font-weight)] leading-[var(--heading-4-line-height)] ${state.property1 === "variant-4" ? "w-[190px]" : ""
      ...
      <div
        className={`absolute ${state.property1 === "variant-5" ? "w-[314px]" : "w-[299px]"} ${state.property1 === "variant-5" ? "left-[937px]" : "left-[945px]"
      ...
      >
        ...
        >
          <div
            className={`font-heading-7 [font-style:var(--heading-7-font-style)] tracking-[var(--heading-7-letter-spacing)] text-[length:var(--heading-7-font-size)] opacity-75 text-gray absolute font-[number:var(--heading-7-font-weight)] whitespace-nowrap leading-[var(--heading-7-line-height)] ${state.property1 === "variant-5" ? "w-[109px]" : ""
          ...
          <div
            className={`font-heading-4 [font-style:var(--heading-4-font-style)] tracking-[var(--heading-4-letter-spacing)] text-[length:var(--heading-4-font-size)] text-black absolute font-[number:var(--heading-4-font-weight)] leading-[var(--heading-4-line-height)] ${state.property1 === "variant-5" ? "w-[173px]" : ""
          ...
          <div
            className={`bg-cover bg-[50%_50%] absolute ${state.property1 === "variant-5" ? "w-[133px]" : "w-[127px]"} ${state.property1 === "variant-5" ? "left-[17px]" : "left-4"
              } ${state.property1 === "variant-5" ? "top-[17px]" : "top-4"} ${state.property1 === "variant-5" ? "h-[247px]" : "h-[235px]"
